...
\usepackage{amsmath,amssymb,textcomp,graphicx,url,bm,lipsum,hyperref,color,subcaption}
...
The INGRID detector lies on the axis of the neutrino beam, but ND280 and SK are 2.5~degrees off-axis, which sets the peak of the neutrino flux at 600~MeV, the energy at which muon neutrino disappearance is most likely. Fig.\ \ref{fig:axis} 
\begin{figure}
...
\subsection{Intitial Beam Test Results}
